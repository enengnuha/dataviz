...
mengenai tujuan penggunaan dari setiap fungsi tersebut dengan
menjalankan `help(nama_fungsi)` atau `?nama_fungsi` di konsol RStudio\!
Tulislah kegunaan dari setiap fungsi secara singkat dengan cara mengisi
bagian \_\_\_\!
...
transformasi data, diantaranya:
  ...
  - `group_by()` \#Most data operations are done on groups defined by
    variables. group\_by() takes an existing tbl and converts it into a
