...
menggunakan paket ggplot2 dan gganimate\! Anda dapat bereksperimen
...
Anda telah berhasil membuat *scatterplot* dasar antara tekanan dan suhu.
...
animate_weather <- 
  ...
  labs(
    ...
    caption = "Grafik ini dibuat oleh enengnurhasanah",
    size = "Windspeed (mps)"
  )
animate_weather
```
